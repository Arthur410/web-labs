...
$(document).ready(function () {
  ...
  console.log("https://localhost:1338/api/userView/".concat(userName));
  $.get("https://localhost:1338/api/userView/".concat(userName), function (user) {
    // Check if the data was successfully fetched
    if (user) {
      var userContainer = $('.user__info');
      var roleMapping = {
        'admin': 'Админ',
        'user': 'Пользователь'
      };
      ...
      var friendsList = user.friends.map(function (friend) {
        return "<li><a href=\"userView.html?userName=".concat(friend, "\">").concat(friend, "</a></li>");
      }).join('');
      $('.user__friends').html("<ul>".concat(friendsList, "</ul>"));
      // acc.push(`<ul><a href="userView.html?userName=${friend}">${friend}</a><ul>${newsItems}</ul></ul>`);
      var newsList = '';

      // Set friends news information
      user.friends.forEach( /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(friend) {
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return $.get("https://localhost:1338/friendsNews/".concat(friend), function (news) {
                  news.forEach(function (userNew) {
                    newsList += "<li>".concat(userNew, "</li>");
                  });
                  var friendsNewsList = "<ul><a href=\"userView.html?userName=".concat(friend, "\">").concat(friend, "</a><ul>").concat(newsList, "</ul></ul>");
